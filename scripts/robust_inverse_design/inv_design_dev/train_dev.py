...
if __name__ == '__main__':
    ...
    tasks = [
        ...
        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "pixel_wise", "crossing", 'ste', 235, False, 0.05, 0.5, 'adam', 1, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 31, 18, "BASELINE_density_MFS", 0, None, True, "all", False, False, False, 40],
        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, [], 0.1, "level_set", "crossing", 'ste', 235, False, 0.05, 0.5, 'adam', 2, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 32, 18, "BASELINE_levelset_no_MFS", 0, None, True, "all", False, False, False, 40],
        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "level_set", "crossing", 'ste', 235, False, 0.05, 0.5, 'adam', 3, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 33, 18, "BASELINE_levelset_MFS", 0, None, True, "all", False, False, False, 40],
        
        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 0, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 34, 18, "BASELINE_match_all_MFS_density_randominit", 0, None, True, "all", False, False, False, 40],
        # ["bending_ceviche", [3, 3], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 1, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 49, 18, "BASELINE_match_all_MFS_density_randominit", 0, None, True, "all", False, False, False, 40],
        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, ['gaussian_blur'], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 2, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 0, 0, 0, 0, 0, 7, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 215, 18, "BASELINE_match_all_MFS_density_randominit", 0, None, True, "all", False, False, False, 40],
        
        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "level_set", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 0, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 35, 18, "BASELINE_match_all_MFS_levelset_randominit", 0, None, True, "all", False, False, False, 40],
        # ["bending_ceviche", [3, 3], (1, 1), (0.48, 0.48), 20, 0.1, ['gaussian_blur'], 0.1, "level_set", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 1, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 50, 18, "BASELINE_match_all_MFS_levelset_randominit", 0, None, True, "all", False, False, False, 40],
        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, ['gaussian_blur'], 0.1, "level_set", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 2, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 0, 0, 0, 0, 0, 7, "cosine", 50, 100, 100, 100, 100, True, False, True, False, True, 'all', 216, 18, "BASELINE_match_all_MFS_levelset_randominit", 0, None, True, "all", False, False, False, 40],

        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, [], 0.1, "level_set", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 2, 30, 0.03, 0.1, 4, 256, 0.9, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 1, 0.2, 0, 3, 2, 7, "cosine", 50, 100, 100, 100, 100, True, True, True, True, False, 'all', 217, 18, "ABLATION_init", 0, None, True, "efficient2c", True, True, False, 40],

        # ["crossing_ceviche", [2.6, 2.6], (1, 1), (0.48, 0.48), 20, 0.1, [], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 0, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 36, 18, "BASELINE_density_no_MFS_random_init", 0, None, True, "all", False, False, False, 40],
        # ["bending_ceviche", [3, 3], (1, 1), (0.48, 0.48), 20, 0.1, [], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 1, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (1,), (1,), (1,), "eigen_mode", "eigen_mode", 1, 0, 0, 0, 0, 0, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 51, 18, "BASELINE_density_no_MFS_random_init", 0, None, True, "all", False, False, False, 40],
        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, [], 0.1, "pixel_wise", "random", 'ste', 235, False, 0.05, 0.5, 'adam', 2, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 0, 0, 0, 0, 0, 7, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 218, 18, "BASELINE_density_no_MFS_random_init", 0, None, True, "all", False, False, False, 40],

        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, [], 0.1, "pixel_wise", "rectangular", 'ste', 235, False, 0.05, 0.5, 'adam', 0, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 0, 0, 0, 0, 0, 7, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 219, 18, "BASELINE_density_no_MFS_rerun", 0, None, True, "all", False, False, False, 40],
        # ["isolator_ceviche", [3, 3], (2, 0.4), (0.8, 0.8), 20, 0.1, ['gaussian_blur'], 0.1, "pixel_wise", "rectangular", 'ste', 235, False, 0.05, 0.5, 'adam', 1, 0.03, 0.03, 0.1, 4, 256, 1, (1,), (3,), (1,), (1, 3), "eigen_mode", "eigen_mode", 0, 0, 0, 0, 0, 7, "cosine", 50, 100, 100, 100, 100, True, False, True, False, False, 'all', 220, 18, "BASELINE_density_MFS_rerun", 0, None, True, "all", False, False, False, 40],
